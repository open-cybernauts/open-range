...
class ServiceSpec(BaseModel):
    """Declarative service lifecycle metadata for rendered services.

    Generated by the Renderer alongside docker-compose.yml.
    Retained as compatibility metadata for validation, tests, and future
    ...
    so orchestration logic can correlate services to logical hosts.
    """
